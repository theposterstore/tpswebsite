...
def explore():
    ...
    # Fetch all items based on the search and category filter
    all_items_cursor = db['inventory'].find(query, {"_id": 1, "item_name": 1, "image_url": 1, "collection_name": 1})
    ...
    return render_template('explore.html', random_list=random_list, collection_names=collection_names_list, all_items_list=all_items_list)
